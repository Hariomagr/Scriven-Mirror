...
public class Custom1 extends PagerAdapter {
    private Context ctx;
    ...
    public Object instantiateItem(final ViewGroup container, final int position) {
        ...
        FirebaseDatabase.getInstance().getReference("Submissions").orderByChild("lang").equalTo("Hindi")
